...
#define N_DECIMAL_RATEVALUE_MM    1 // Rate or velocity value in mm/min
#define N_DECIMAL_SETTINGVALUE    4 // Decimals for floating point setting values
...
#define INVERT_LIMIT_PIN_MASK ((1<<X_LIMIT_BIT))
